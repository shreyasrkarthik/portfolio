    ...
    <nav className="bg-gradient-to-r from-white-100 via-white-800 to-white-100 animate-gradient text-white p-1 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Website Title */}
          <span className="text-2xl font-bold text-color text-[#c8cefa]">Code, Content and Chronicles</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          {["Home", "Contact", "Social", "About"].map((item) => (
            <Link
              ...
              className="px-4 py-2 border border-white rounded-md hover:bg-[#c8cefa] hover:text-blue-600 transition"
            >
              {item}
            </Link>
          ))}
